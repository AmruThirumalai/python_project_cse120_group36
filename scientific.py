...
while calcstate != 'exit':
    if calcstate == 'Scientific':
        ...
        but_xSqr = tk.Button(calc, text="x²", command=lambda: add_to_calculation("sqr("), width=5, font=DEFAULT_FONT_STYLE,
                             fg=INK_BLUE, bg=WHITE)
        ...
        but_abs = tk.Button(calc, text="abs", command=lambda: add_to_calculation('absou('), width=5, fg=PEARL_PINK, bg=WHITE, font=DEFAULT_FONT_STYLE)
        ...
        but_asin = tk.Button(calc, text='asin', command=lambda: add_to_calculation('arcsin('), width=5, font=('Arial', 14),
                               fg=PEARL_PINK, bg=WHITE)
        ...
        but_tan = tk.Button(calc, text="tan", command=lambda: add_to_calculation("tan("), width=5, font=DEFAULT_FONT_STYLE,
                              fg=PEARL_PINK, bg=WHITE)
        but_tan.grid(row=7, column=6)

        but_atan = tk.Button(calc, text="atan", command=lambda: add_to_calculation("arctan("), width=5, font=DEFAULT_FONT_STYLE,
                              fg=PEARL_PINK, bg=WHITE)
